...
<head>
    ...
    <title>Quản lý thuốc - Nhân viên</title>
                    ...
                    <ul class="nav nav-tabs mb-3" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link <?= (isset($filter) && $filter === 'expiring') ? 'active' : '' ?> text-warning" 
                               href="index.php?page=nhanvien_thuoc&filter=expiring">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                                <div class="d-flex gap-2 flex-wrap">
                                    <a href="index.php?page=nhanvien_thuoc&action=admin_thuoc_form" class="btn btn-primary">
                                ...
                                <form method="GET" class="d-flex gap-2">
                                    <input type="hidden" name="page" value="nhanvien_thuoc">
                                    ...
                                    <?php if (!empty($search)): ?>
                                        <a href="index.php?page=nhanvien_thuoc&filter=all" class="btn btn-outline-secondary"><i class="bi bi-x"></i></a>
                                    <?php endif; ?>
                                </form>
                                <?php endif; ?>
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group btn-group-sm">
                                                            <a href="index.php?page=nhanvien_thuoc&action=admin_thuoc_form&id=<?= $thuoc['ma_thuoc'] ?>" 
                                                               class="btn btn-outline-primary btn-action" title="Sửa">
                                                                <i class="bi bi-pencil"></i>
                                                            </a>
                                                            <a href="index.php?page=nhanvien_thuoc&action=admin_thuoc_delete&id=<?= $thuoc['ma_thuoc'] ?>" 
                            ...
                            <div class="card-footer">
                                <nav>
                                    <ul class="pagination pagination-sm mb-0 justify-content-center">
                                        <?php if ($page > 1): ?>
                                            <li class="page-item">
                                                <a class="page-link" href="?page=nhanvien_thuoc&p=<?= $page - 1 ?><?= !empty($search) ? '&search=' . urlencode($search) : '' ?><?= isset($filter) && $filter !== 'all' ? '&filter=' . $filter : '' ?>">Trước</a>
                                            </li>
                                        <?php endif; ?>
                                        <?php for ($i = max(1, $page - 2); $i <= min($totalPages, $page + 2); $i++): ?>
                                            <li class="page-item <?= $i == $page ? 'active' : '' ?>">
                                                <a class="page-link" href="?page=nhanvien_thuoc&p=<?= $i ?><?= !empty($search) ? '&search=' . urlencode($search) : '' ?><?= isset($filter) && $filter !== 'all' ? '&filter=' . $filter : '' ?>"><?= $i ?></a>
                                            </li>
                                        <?php endfor; ?>
                                        <?php if ($page < $totalPages): ?>
                                            <li class="page-item">
                                                <a class="page-link" href="?page=nhanvien_thuoc&p=<?= $page + 1 ?><?= !empty($search) ? '&search=' . urlencode($search) : '' ?><?= isset($filter) && $filter !== 'all' ? '&filter=' . $filter : '' ?>">Sau</a>
                                            </li>
                                        <?php endif; ?>
                                    </ul>
                                </nav>
