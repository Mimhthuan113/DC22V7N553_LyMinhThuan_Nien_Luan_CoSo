...
<head>
    ...
    <title>Quản lý tin tức - Nhân viên</title>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                                ...
                                <form method="GET" class="d-flex gap-2">
                                    <input type="hidden" name="page" value="nhanvien_tintuc">
                                    ...
                                    <?php if (!empty($search)): ?>
                                        <a href="index.php?page=nhanvien_tintuc" class="btn btn-outline-secondary"><i class="bi bi-x"></i></a>
                                    <?php endif; ?>
                                </form>
                            </div>
                        </div>
                            ...
                            <div class="card-footer">
                                <nav>
                                    <ul class="pagination pagination-sm mb-0 justify-content-center">
                                        <?php if ($page > 1): ?>
                                            <li class="page-item">
                                                <a class="page-link" href="?page=nhanvien_tintuc&p=<?= $page - 1 ?><?= !empty($search) ? '&search=' . urlencode($search) : '' ?>">Trước</a>
                                            </li>
                                        <?php endif; ?>
                                        <?php for ($i = max(1, $page - 2); $i <= min($totalPages, $page + 2); $i++): ?>
                                            <li class="page-item <?= $i == $page ? 'active' : '' ?>">
                                                <a class="page-link" href="?page=nhanvien_tintuc&p=<?= $i ?><?= !empty($search) ? '&search=' . urlencode($search) : '' ?>"><?= $i ?></a>
                                            </li>
                                        <?php endfor; ?>
                                        <?php if ($page < $totalPages): ?>
                                            <li class="page-item">
                                                <a class="page-link" href="?page=nhanvien_tintuc&p=<?= $page + 1 ?><?= !empty($search) ? '&search=' . urlencode($search) : '' ?>">Sau</a>
                                            </li>
                                        <?php endif; ?>
                                    </ul>
                                </nav>
