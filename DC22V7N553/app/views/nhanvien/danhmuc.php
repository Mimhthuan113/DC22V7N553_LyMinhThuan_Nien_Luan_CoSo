                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                                <div class="d-flex gap-2">
                                    <a href="index.php?page=nhanvien_danhmuc&action=admin_danhmuc_form" class="btn btn-primary">
                                        <i class="bi bi-plus-circle"></i> Thêm danh mục mới
                                    </a>
                                </div>
                                <form method="GET" class="d-flex gap-2">
                                    <input type="hidden" name="page" value="nhanvien_danhmuc">
                                    ...
                                    <?php if (!empty($search)): ?>
                                        <a href="index.php?page=nhanvien_danhmuc" class="btn btn-outline-secondary"><i class="bi bi-x"></i></a>
                                    <?php endif; ?>
                                </form>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        function renderCategoryTree($categories, $level = 0, &$index = 0) {
                                            ...
                                            foreach ($categories as $cat) {
                                                ...
                                                $output .= '<a href="index.php?page=nhanvien_danhmuc&action=admin_danhmuc_form&id=' . $cat['ma_danh_muc'] . '" class="btn btn-outline-primary btn-action" title="Sửa"><i class="bi bi-pencil"></i></a>';
                                                $output .= '<a href="index.php?page=nhanvien_danhmuc&action=admin_danhmuc_delete&id=' . $cat['ma_danh_muc'] . '" class="btn btn-outline-danger btn-action" onclick="return confirm(\'Bạn có chắc muốn xóa danh mục này?\')" title="Xóa"><i class="bi bi-trash"></i></a>';
                                                $output .= '</div>';
                                                $output .= '</td>';
                                                $output .= '</tr>';
